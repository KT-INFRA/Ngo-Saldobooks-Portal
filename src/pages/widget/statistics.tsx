...
import AnalyticEcommerce from 'components/cards/statistics/AnalyticEcommerce'; //2
...
import AssignUsers from 'sections/widget/statistics/AssignUsers'; //2
import PermissionBlock from 'sections/widget/statistics/PermissionBlock';
import DropboxStorage from 'sections/widget/statistics/DropboxStorage'; //2
import SwitchBalanace from 'sections/widget/statistics/SwitchBalanace'; //2
