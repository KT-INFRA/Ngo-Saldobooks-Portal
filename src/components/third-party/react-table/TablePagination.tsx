    ...
    <Grid spacing={1} container alignItems="center" justifyContent="space-between" sx={{ width: 'auto' }}>
      <Grid item>
        <Stack direction="row" spacing={1} alignItems="center">
          <Stack direction="row" spacing={1} alignItems="center">
            ...
            <FormControl sx={{ m: 1 }}>
              <Select
                ...
                onClose={handleClose}
                onOpen={handleOpen}
                value={pageSize ? Number(pageSize) : getState().pagination.pageSize}
          ...
          <TextField
            size="small"
            type="number"
            value={page ? Number(page) + 1 : getState().pagination.pageIndex + 1}
            onChange={(e) => {
      ...
      <Grid item sx={{ mt: { xs: 2, sm: 0 } }}>
        <Pagination
          ...
          count={getPageCount()}
          page={page ? Number(page) : getState().pagination.pageIndex + 1}
