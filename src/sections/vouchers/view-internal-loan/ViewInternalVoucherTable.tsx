...
interface ViewInternalVoucherTableProps {}

// eslint-disable-next-line no-empty-pattern
export default function ViewInternalVoucherTable({}: ViewInternalVoucherTableProps) {
  const { columns, data, isLoading: loading, meta, handleChangePage } = useViewInternalLoanContext()!;
      ...
      <Table size="small">
        ...
        <TableBody>
          {Array(10)
            ...
            .map((item: number) => (
              <TableRow key={item}>
                {Array.from({ length: 6 }, (col: number, index: number) => (
